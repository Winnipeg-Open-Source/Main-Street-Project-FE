...
describe ('ClothesDonationForm', () => {
    ...
    it ('has placeholders when empty', async () => {
        const { getByLabelText, getByPlaceholderText, getByTestId } = renderWithTheme(<ClothesDonationForm />);
    ...
    it ('has all fields used', async () => {
        const { getByLabelText, getByPlaceholderText, getByTestId } = renderWithTheme(<ClothesDonationForm {...mockClothingDonationProps} />);
