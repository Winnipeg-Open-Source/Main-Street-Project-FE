...
jest.mock('components/FoodDonationForm', () => () => (
    <div>FoodDonationForm</div>
));
jest.mock('components/ClothesDonationForm', () => () => (
    <div>ClothesDonationForm</div>
));
jest.mock('components/HouseholdItemDonationForm', () => () => (
    <div>HouseholdItemDonationForm</div>
));
jest.mock('components/MiscellaneousDonationForm', () => () => (
    <div>MiscellaneousDonationForm</div>
));
...
describe('ItemForm', () => {
    ...
    it('can select household item donation form', () => {
        const { getByText } = renderWithTheme(
            <ItemForm itemType='Household Item' />
        );
    ...
    it('can select miscellaneous donation form', () => {
        const { getByText } = renderWithTheme(
            <ItemForm itemType='Miscellaneous' />
        );
